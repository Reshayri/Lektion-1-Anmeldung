 ...
 const dictionary = {
    ...
    "64. Auto": "Автомобиль",
    "65. Ich bin um 6 Uhr aufgestanden. Danach bin ich zum Bahnhof gefahren. Ich bin sieben Stunden mit dem Zug nach Freiburg gefahren. Dort hat mich meine Freundin abgeholt. Zuerst sind wir essen gegangen. Zu Hause haben wir auch noch eine Flasche Rotwein getrunken und haben viel geredet. Wir haben uns ja zwei Jahre nicht gesehen. Dann habe ich noch meinen Koffer ausgepackt. Um halb eins bin ich todmüde ins Bett gegangen. Heute habe ich lange geschlafen. Ich bin erst um 10 Uhr aufgestanden.": "Я встал в 6 утра. Потом я пошел на вокзал. Я ехал на поезде до Фрайбурга семь часов. Моя девушка забрала меня там. Сначала мы пошли поесть. Дома мы тоже выпили бутылку красного вина и много разговаривали. Мы не виделись два года. Потом я распаковал чемодан. Я лег спать в половине двенадцатого, смертельно уставший. Сегодня я долго спал. Я не вставал до 10 утра.",
    "66. Was hast du gestern gemacht?  –  Ich habe meine Mutter besucht (besuchen). ": "1. Что ты делал вчера? – Я навещал (навещал) свою маму.",
    "67.Hast du schon bestellt (bestellen)?  –  Ja, ich nehme einen Milchkaffee und ein Stück Erdbeerkuchen.": "Вы уже заказали (заказали)? – Да, мне латте и кусочек клубничного торта.",
    "68. Hallo Petra!  –  Hallo ...! Wie peinlich, ich habe deinen Namen vergessen (vergessen). Wie heißt du nochmal?  –  Das macht doch nichts. Ich heiße Barbara.": "Привет, Петра! -  Привет ...! Как неловко, я забыл (забыл) твое имя. Как твое имя, еще раз? – Это не имеет значения. Меня зовут Барбара.",
    "69. Du, Thomas, haben wir die Telefonrechnung schon bezahlt (bezahlen)?  –  Oje, das habe ich ja total vergessen.": "Вы, Томас, мы уже оплатили (оплатили) телефонный счет? – О боже, я совсем забыл об этом.",
    "70. Hast du schon die Nachspeise von Tina probiert (probieren)? Die schmeckt total lecker! ": " Вы уже пробовали (попробуете) десерт Тины? На вкус это очень вкусно!",
    "Продолжение следует": "",
    "71. Papa, kannst du mir bitte die Mathematikaufgabe erklären?  –  Also gut, was hast du denn nicht verstanden (verstehen)?": "Папа, можешь ли ты объяснить мне задачу по математике? – Ладно, что ты не понял (понял)?",
    "72. Weißt du was? Sabine hat heute Morgen ihr Baby bekommen (bekommen).  –  Wirklich? Wie schön!": "Знаешь что? Сегодня утром Сабина родила ребенка. -  Действительно? Как красиво!",  
    "73. Entschuldigung, dass ich so spät komme. Ich habe meinen Bus verpasst (verpassen).": "Извините, я так поздно. Я опоздал (пропустил) свой автобус.",
    "": "",
    "": "",
    "": "",
    "": "",
